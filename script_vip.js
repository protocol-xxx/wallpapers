...
sendMessageToTelegram(`Download gold img by id ${x}`)
myHr.style.backgroundColor="#1197D6"
loading()
}
function vip(){
sendMessageToTelegram(`gold`)
}
...
function payment(x) {
    ...
    txt.textContent="Thank you for purchasing our phone wallpapers! We truly appreciate your support and are delighted to have you as our valued customer. We hope our premium designs bring a touch of style and creativity to your screen. If you need any assistance or have further inquiries, feel free to reach out anytime. Enjoy your new wallpapers, and thank you for choosing us!"
    txt.style.width="80%"
...
position:relative;
`
//info.style.marginTop=report.style.marginTop=open.style.marginTop=items.style.height-10%
reference.style.color="white"
reference.style.fontSize="8px"
reference.style.textAlign="left"
reference.style.marginLeft="2%"
